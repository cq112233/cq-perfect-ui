 ...
 * @LastEditors: chen qi
 * @LastEditTime: 2023-04-17 17:04:01
 * @Description: ~
-->
...
import { CqCalendar, CqChart, CqUpload ,CqDragTable,CqSortTree} from '../packages/index'
...
onMounted(() => {
  setTimeout(() => {
    console.log('cqTree.value', cqTree.value.getHalfIds())
  }, 4000)
})
